...
export const presetGraphs: PresetGraph[] = [
  {
    ...
    graph: {
      vertices: [
        ...
        { id: 'B', x: 550, y: 140, weight: 10, originalWeight: 10, inCover: false, isZero: false },
        { id: 'C', x: 200, y: 380, weight: 4, originalWeight: 4, inCover: false, isZero: false },
        { id: 'D', x: 550, y: 380, weight: 2, originalWeight: 2, inCover: false, isZero: false },
      ],
      edges: [
